...
function LoginModal() {
  ...
  return (
    <div>
      <button
        onClick={toggleModal}
        className="hover:bg-[#007991] text-white font-semibold py-2 px-4 border-white border-[2px] rounded-md"
      >
        Login
      </button>
        ...
        {isLogin ? (
          <>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full px-4 py-2 bg-[#007991] text-white font-semibold rounded-md focus:outline-none focus:ring focus:ring-blue-200"
              >
                Login
              </button>
