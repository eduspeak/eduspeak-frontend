  ...
  return (
    <div className="max-w-md">
      <div className="relative shadow dark:bg-gray-800 dark:border-gray-700">
        <img className="w-full h-auto rounded-lg " src={imageSrc} alt={title} />
      ...
      <div className="p-5">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white max-w-md">
          {title}
        </h5>
