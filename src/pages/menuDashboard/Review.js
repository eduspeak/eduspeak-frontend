...
import StarRating from "../../../src/components/Star";
            ...
            <div className="w-full ">
              ...
              <div className="py-1 mt-2">
                ...
                <textarea
                  name="komentar"
                  id="komentar"
                  rows="4" // Anda bisa mengatur jumlah baris sesuai kebutuhan
              ...
              <button
                type="submit"
                className="text-white bg-[#007991] mt-6 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Save
              </button>
            </div>
